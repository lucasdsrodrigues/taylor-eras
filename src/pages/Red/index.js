...
const redMusicVideos = [
    ...
    { title: "22", desc: "A celebração da juventude", id: "AgFeZr5ptV8" },
    { title: "I Knew You Were Trouble", desc: "O arrependimento em forma de clipe", id: "vNoKguSdy4Y" },
    { title: "Everything Has Changed", desc: "feat. Ed Sheeran — Uma amizade atemporal", id: "w1oM3kQpXRo" },
    { title: "Red", desc: "O vermelho que define tudo", id: "Zlot0i3Zykw" },
    { title: "The Last Time", desc: "feat. Gary Lightbody — O último adeus", id: "QuijXg8wm28" },
    { title: "I Bet You Think About Me", desc: "(Taylor's Version) feat. Chris Stapleton", id: "5UMCrq-bBCg" },
...
const Red = () => {
    ...
    const prevMV = () => goToMV((activeMV - 1 + redMusicVideos.length) % redMusicVideos.length);
    const nextMV = () => goToMV((activeMV + 1) % redMusicVideos.length);
        ...
        <div className={`red-page-container ${loaded ? 'red-loaded' : ''}`}>
            ...
            <section className="atw-cinematic-section">
                <div className="atw-container">
                    ...
                    <div className="atw-cinematic-layout">
                        ...
                        <div className="atw-ten-min-section">
                            <div className="atw-ten-min-header">
                                <span className="atw-tag">ALL TOO WELL</span>
                                <h3 className="atw-ten-min-title">10 Minute Version</h3>
                                <p className="atw-ten-min-desc">A versão completa, sem cortes — 10 minutos de emoção pura que mudaram a história da música.</p>
                            </div>
                            <div className="atw-ten-min-player">
                                <div className="red-mv-slide-inner">
                                    <iframe
            ...
            <section className="red-mv-section">
                <div className="red-mv-container">
                    ...
                    <div className="red-mv-slider-wrapper">
                        <button className="red-mv-nav-btn prev" onClick={prevMV}>‹</button>
                        <button className="red-mv-nav-btn next" onClick={nextMV}>›</button>

                        <div className="red-mv-slider-viewport">
                            <div className="red-mv-slider-track" style={{ transform: `translateX(-${activeMV * 100}%)` }}>
                                {redMusicVideos.map((video, index) => (
                                    <div className={`red-mv-slide ${activeMV === index ? 'is-active' : ''}`} key={index}>
                                        <div className="red-mv-slide-inner">
                                            <iframe
                                        ...
                                        <h3 className="red-mv-slide-title">{video.title}</h3>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="red-mv-dots">
                        {redMusicVideos.map((_, index) => (
                            <button
                                key={index}
                                className={`red-mv-dot ${activeMV === index ? 'is-active' : ''}`}
