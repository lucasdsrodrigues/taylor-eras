...
const Lover = () => {
    ...
    const [erasRef, erasInView] = useInView();
    ...
    const musicVideos = [
        ...
        { id: "-BjZmE2gtdo", title: "Lover", thumb: "https://img.youtube.com/vi/-BjZmE2gtdo/sddefault.jpg" },
        { id: "AqAJLh9wuZ0", title: "The Man", thumb: "https://img.youtube.com/vi/AqAJLh9wuZ0/sddefault.jpg" },
    ...
    const galleryImages = [
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/a/a6/LShoot-21.jpeg/revision/latest/scale-to-width-down/1000?cb=20231224082924", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/b/bc/LShoot-22.jpeg/revision/latest/scale-to-width-down/1000?cb=20231224083008", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/d/d1/LShoot-16.jpeg/revision/latest/scale-to-width-down/1000?cb=20231224083121", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/1/17/LShoot-25.jpg/revision/latest/scale-to-width-down/1000?cb=20231224082707", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/3/3e/LShoot-24.jpg/revision/latest/scale-to-width-down/1000?cb=20231224083213", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/8/85/LShoot-26.jpg/revision/latest/scale-to-width-down/1000?cb=20231224130843", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/4/41/LShoot-9.jpeg/revision/latest/scale-to-width-down/1000?cb=20220823104005", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/7/7f/LShoot-18.jpeg/revision/latest/scale-to-width-down/1000?cb=20240103081014", caption: "Lover Photoshoot" },
        { img: "https://static.wikia.nocookie.net/taylor-swift/images/0/0f/LShoot-5Full.jpeg/revision/latest/scale-to-width-down/1000?cb=20250901030104", caption: "Lover Photoshoot" },
    ];
    ...
    return (
        <main className={`lover-page ${loaded ? 'lover-loaded' : ''}`}>
            ...
            {/* ═══ HERO SECTION ═══ */}
            <section
                className="lover-hero"
            >
                <div className="lover-hero-gradient" style={{ transform: `translateY(${scrollY * 0.3}px)` }}></div>
                <div className="lover-texture-overlay" style={{ transform: `translateY(${scrollY * 0.3}px)` }}></div>
            ...
            <section className={`lover-eras-section ${erasInView ? 'lover-in-view' : ''}`} ref={erasRef}>
                <div className="lover-section-header">
